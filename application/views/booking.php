  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="content">
        ...
        <div class="container">
    <a href="<?php echo base_url('index.php/pemesanan/input'); ?>" class="btn btn-success btn-sm">Tambah Data</a> <br> <br>
    <div class="card">
            ...
            <tbody>
                <?php foreach ($pemesanan as $row) : ?>
                    <tr>
                        ...
                        <td><a href="<?php echo base_url('index.php/Jadwal_ctrl/daftar_jadwal/') . $row['id_jadwal']; ?>"><?php echo $row['id_jadwal']; ?></a></td>
                        <td>
                            <?php
                        ...
                        <td>
                            <a href="<?php echo base_url('index.php/Pemesanan/edit/' . $row['id_pemesanan']); ?>" class="btn btn-warning btn-sm">Edit</a>
                            <a href="<?php echo base_url('index.php/Pemesanan/delete/' . $row['id_pemesanan']); ?>" class="btn btn-danger btn-sm" onclick="return confirmDelete()">Hapus</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
