  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="content">
        ...
        <div class="container">
        <a href="<?php echo base_url('index.php/pesawat_ctrl/input_pesawat'); ?>" class="btn btn-success btn-sm">Tambah Data</a> <br> <br>
          <div class="card">
            ...
            <table class="table table-striped">
              ...
              <tbody>
                <?php if (!empty($pesawat)) : ?>
                  <?php foreach ($pesawat as $row) : ?>
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo base_url('index.php/Pesawat_ctrl/edit/' . $row['id_pesawat']); ?>" class="btn btn-warning btn-sm">Edit</a>
                        <a href="<?php echo base_url('index.php/Pesawat_ctrl/delete/' . $row['id_pesawat']); ?>" class="btn btn-danger btn-sm" onclick="return confirmDelete()">Hapus</a>
                ...
                <?php else : ?>
                  <tr>
                    <td colspan="6">Tidak ada data pesawat</td>
                  </tr>
                <?php endif; ?>
              </tbody>
            </table>
