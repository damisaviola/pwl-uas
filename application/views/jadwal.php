  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="content">
        ...
        <div class="container">
        <a href="<?php echo base_url('index.php/Jadwal_ctrl/input_jadwal'); ?>" class="btn btn-success btn-sm">Tambah Data</a> <br> <br>
          <div class="card">
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <?php foreach ($jadwal_penerbangan as $row) { ?>
                  <tr>
                    <td><?php echo $row['id_jadwal']; ?></td>
                    <td><a href="<?php echo base_url('index.php/penerbangan_ctrl/show_penerbangan/') . $row['id_rute']; ?>"><?php echo $row['id_rute']; ?></a></td>
                    <td><?php echo $this->Maskapai_model->get_nama_maskapai_by_id($row['id_maskapai']); ?></td>
                    <td><?php echo $this->Pesawat_model->get_nama_pesawat_by_id($row['id_pesawat']); ?></td>
                    <td><?php echo $row['tanggal']; ?></td>
                    <td><?php echo $row['harga']; ?></td>
                    <td>
                      <a href="<?php echo base_url('index.php/jadwal_ctrl/edit/' . $row['id_jadwal']); ?>" class="btn btn-warning btn-sm">Edit</a>
                      <a href="<?php echo base_url('index.php/Jadwal_ctrl/delete/' . $row['id_jadwal']); ?>" class="btn btn-danger btn-sm" onclick="return confirmDelete()">Hapus</a>
                    </td>
                  </tr>
                <?php } ?>
              </tbody>
